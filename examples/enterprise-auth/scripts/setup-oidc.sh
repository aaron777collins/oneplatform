...
echo "    3. Test login via the browser at: $PLATFORM_URL/auth/oauth/authorize?tenantId=$TENANT_ID"
echo "       Or use an API key: op auth login --platform $PLATFORM_URL --key <api-key>"
