...
// The plugin service verifies HS256 JWTs using OP_JWT_SECRET.
...
/**
 * Creates a signed HS256 JWT that the plugin service's auth middleware
 * will accept. Each call generates a unique jti to avoid revocation conflicts.
 *
 * Use roles: ["platform-admin"] for routes that install or uninstall plugins.
 */
