...
[@oneplatform/sdk](../README.md) / ClientError

# Class: ClientError

Defined in: [packages/sdk/src/errors/client-errors.ts:11](https://github.com/aaron777collins/oneplatform/blob/e5bb8f585c10107015e961e4e99a8fbe094a70d3/packages/sdk/src/errors/client-errors.ts#L11)
...
- [`PaginationLimitError`](PaginationLimitError.md)

## Constructors

### Constructor

> **new ClientError**(`options`): `ClientError`
